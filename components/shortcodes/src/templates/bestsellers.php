        ...
        <div class="product-cont">
          ...
          <div class="sum-link clearfix">
            ...
            <div class="sum">
              ...
              <?php if ($product['price_regular'] > 0 && $product['price_regular'] > $product['price_uah']) : ?>
                <small style="text-decoration:line-through"><?= $product['price_regular'] ?> <span> грн</span></small>
              <?php endif; ?>
            </div>
          </div>
