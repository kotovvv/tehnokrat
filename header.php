...
<noscript>
	<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TLQM497" height="0" width="0"
		...
		<div class="feedback-poput">
			<div class="feedback-content">
				...
				<form>
					...
					<textarea
						:class="{ 'error': ! content.length }"
						v-model="content"
						placeholder="Отзыв"
					></textarea>
					<input
						:disabled="0 == content.length"
						type="submit"
						value="Оставить отзыв"
						@click.stop.prevent="postComment"
					/>
				</form>
			</div>
		</div>
