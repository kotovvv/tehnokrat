...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-TLQM497');
  </script>
...
<body <?php body_class(); ?>>
  ...
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TLQM497" height="0" width="0" style="display:none;visibility:hidden"></iframe>
  </noscript>
  ...
  <div id="vue-app">
    ...
    <section class="slider_popup">
      <div class="slider_popup_content clearfix">
        <i class="close"></i>
        <div class="slider">
        </div>
      </div>
    ...
    <?php if (is_page('reviews')) : ?>
      <div class="feedback-poput">
        <div class="feedback-content">
          <i class="close" @click.stop.prevent="closePopup"></i>
          <h5>Оставить отзыв</h5>
          <div class="rating-content-with-message">
            <span class="rating-content-with-message-warning" v-show="showKarmaWarning">Поставьте оценку</span>
            <div class="rating-content" @click="getKarma">
          ...
          <form>
            <input v-model="name" type="text" placeholder="Имя и Фамилия">
            <input v-model="email" type="email" placeholder="E-mail">
            <textarea :class="{ 'error': ! content.length }" v-model="content" placeholder="Отзыв"></textarea>
            <input :disabled="0 == content.length" type="submit" value="Оставить отзыв" @click.stop.prevent="postComment" />
          </form>
        </div>
      </div>
    <?php endif; ?>
        ...
        <div class="mc">
          <div class="woocommerce-product-search search">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g>
                <path d="M21.7312 20.436L15.475 14.1798C16.6868 12.6829 17.4165 10.7808 17.4165 8.70918C17.4165 3.90772 13.5097 0.000915527 8.70822 0.000915527C3.90677 0.000915527 0 3.90768 0 8.70913C0 13.5106 3.90681 17.4174 8.70826 17.4174C10.7799 17.4174 12.682 16.6878 14.1789 15.4759L20.4351 21.7321C20.6138 21.9109 20.8484 22.0007 21.0831 22.0007C21.3178 22.0007 21.5525 21.9109 21.7312 21.7321C22.0896 21.3737 22.0896 20.7944 21.7312 20.436ZM8.70826 15.5841C4.91695 15.5841 1.83333 12.5004 1.83333 8.70913C1.83333 4.91782 4.91695 1.8342 8.70826 1.8342C12.4996 1.8342 15.5832 4.91782 15.5832 8.70913C15.5832 12.5004 12.4995 15.5841 8.70826 15.5841Z" fill="white"></path>
              </g>
            </svg>
